...
# TODO: update-rc.d is apparently not the preferred way to modify startup
# settings for ubuntu? Confirm what is best practice and put in relevant command
# read discussion here: http://askubuntu.com/questions/2263/chkconfig-alternative-for-ubuntu-server
